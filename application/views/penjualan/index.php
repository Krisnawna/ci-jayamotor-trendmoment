            ...
            foreach ($penjualan as $key => $value): ?>
              <tr>
                ...
                <td>
                  ...
                  <!-- <a class="btn btn-sm btn-warning" href="<?php echo base_url('DataPenjualan') ?>/ubah/<?php echo $value->id_penjualan ?>" >Update</a> -->
                  <a class="btn btn-sm btn-success" href="<?php echo base_url('DataPenjualan') ?>/ubah/<?php echo $value->id_penjualan ?>" >Edit</a>
                </td>
              </tr>
            <?php endforeach ?>
          </tbody>
